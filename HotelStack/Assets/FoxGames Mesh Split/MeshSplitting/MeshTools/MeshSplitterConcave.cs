...
//            //Debug.DrawLine(edge.Left, edge.Right, Color.yellow, 5f);
//            //Vector3 center = Vector3.Lerp(edge.Left, edge.Right, .5f);
//            //Debug.DrawLine(center, center + edge.Normal * normalLength, Color.cyan, 5f);
//            //Debug.DrawLine(edge.Left, edge.Left + _mesh.normalsNew[index0] * normalLength, Color.magenta, 5f);
//            //Debug.DrawLine(edge.Right, edge. + _mesh.normalsNew[index1] * normalLength, Color.magenta, 5f);
//#endif
        }
